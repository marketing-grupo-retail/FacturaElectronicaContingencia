...
public class TrxonlineTransactionInDBVO 
    
{
	...
	*/
	...
	public void setGrosspos(Long grosspos) {
		this.grosspos = grosspos;
	}
	public Long getGrossneg() {
		return grossneg;
	}
	public void setGrossneg(Long grossneg) {
	...
	public String getElectBillStatus() {
		return electBillStatus;
	}
	public void setElectBillStatus(String electBillStatus) {
		this.electBillStatus = electBillStatus;
	}
